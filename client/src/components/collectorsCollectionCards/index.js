...
function CollectorsCollectionCard(props) {
  ...
  return (
    ...
    <Row>
        {
            CollectionsData.slice(0, !collections ? 3 : CollectionsData.length).map((data)=>(
                    ...
                    <div className='collections_cards metablog_cards' key={data.id}>
                        ...
                        <Row className='collections_cards-grid'>
                            <Col >
                                <Row>
                                    <Col style={{padding:5}}>
                                        <Image fluid src={data.grid_img2} alt="gridimg1" className="metabloq_img img-zoom-animation"/>
                                        </Col>
                                </Row>
                                <Row>
                                    <Col style={{padding:5}}>
                            ...
                            <Col >
                                ...
                                <Row>
                                    <Col style={{padding:5}}>
                                        <Image fluid src={data.grid_img2} alt="gridimg1" className="metabloq_img img-zoom-animation"/></Col>
                                </Row>
                            </Col>
                        </Row>
                        <div className='d-flex justify-content-between align-items-center'>
                            <div className='d-flex flex-column'>
                                <span className='font-weight-bold poppins'>{data.c_name}</span>
                                <small className='secondary-text poppins'>created by <small className="font-weight-bold text-dark">{data.c_sub_name}</small></small>
                            </div>
